...
export const updateObjective = async (req, res) => {
  try {
    ...
    const { title, parent_objective_id, visibility, description } =
      req.validated.body;
    const updates = {};
...
export const submitObjective = async (req, res) => {
  try {
    ...
    const objective = await objectiveService.submitObjective(
      req.user,
      objectiveId,
    );
...
export const approveObjective = async (req, res) => {
  try {
    ...
    const objective = await objectiveService.approveObjective(
      req.user,
      objectiveId,
    );
...
export const publishObjective = async (req, res) => {
  try {
    ...
    const objective = await objectiveService.publishObjective(
      req.user,
      objectiveId,
      updates,
    );
...
export const rejectObjective = async (req, res) => {
  try {
    ...
    const objective = await objectiveService.rejectObjective(
      req.user,
      objectiveId,
      comment?.trim(),
    );
...
export const revertToDraft = async (req, res) => {
  try {
    ...
    const objective = await objectiveService.revertToDraft(
      req.user,
      objectiveId,
    );
...
export const getAvailableParentObjectives = async (req, res) => {
  try {
    ...
    res.success(
      "Available parent objectives retrieved successfully",
      200,
      result.data,
      {
...
export const getObjectiveById = async (req, res) => {
  try {
    ...
    const objective = await objectiveService.getObjectiveById(
      req.user,
      objectiveId,
    );
